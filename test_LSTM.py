...
#os.environ['CUDA_VISIBLE_DEVICES'] = "device=cuda"
...
#    if(fold == 7 or fold ==8):
 #       continue
    ...
    model_fall.add(LSTM(units =64,input_shape = ((window_size-1),3)))
    model_fall.add(Dropout(0.2))
    ...
    cm.append(confusion_matrix(Y_test_gd, max_y_pred_test))
